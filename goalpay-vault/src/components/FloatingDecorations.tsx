...
const FloatingDecorations = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-20 left-10 opacity-20 animate-sparkle">
        <div className="w-8 h-8 rounded-full bg-goal-primary"></div>
      </div>
      
      <div className="absolute top-40 right-16 opacity-15 animate-sparkle" style={{ animationDelay: '1s' }}>
        <div className="w-6 h-6 rounded-full bg-goal-accent"></div>
      </div>
      
      <div className="absolute top-60 left-20 opacity-25 animate-sparkle" style={{ animationDelay: '2s' }}>
        <div className="w-4 h-4 rounded-full bg-goal-border"></div>
      </div>
      
      <div className="absolute bottom-40 right-10 opacity-20 animate-sparkle" style={{ animationDelay: '0.5s' }}>
        <div className="w-10 h-10 rounded-full bg-goal-primary"></div>
      </div>
      
      <div className="absolute bottom-20 left-16 opacity-15 animate-sparkle" style={{ animationDelay: '1.5s' }}>
